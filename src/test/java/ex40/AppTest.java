...
class AppTest {
    ...
    void putIn() {
        ...
        assertEquals(multiValueMap, App.putIn(multiValueMap,0,firstName,lastName,position,separationDate));
    }
    ...
    void filtering() {
        ...
        people.add(0);
        assertEquals(people,App.filtering("John", multiValueMap,lastName,firstName));
    }
}